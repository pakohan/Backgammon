...
public class GameWithGui {
    ...
    public void playTurn(IGame currentGame, IPlayer plr, BackgammonFrame bf) {
        ...
        for (int index = currentGame.automaticTakeOut(); index < currentGame.getTurnsNumber(); index++) {
            ...
            if (!getStartAndTargetNumbers(currentGame, currentGame.getGameMap(), plr, bf)) {
    ...
    private boolean getStartAndTargetNumbers(IGame currentGame, Field[] gm, IPlayer plr, BackgammonFrame bf) {
