...
public final class GameWithGui {
	...
	public static void playTurn(final Game currentGame, final IPlayer plr,
			final BackgammonFrame bf) {
	...
	private static boolean notGetStartAndTargetNumbers(final Game currentGame,
			final Field[] gm, final IPlayer plr, final BackgammonFrame bf) {
